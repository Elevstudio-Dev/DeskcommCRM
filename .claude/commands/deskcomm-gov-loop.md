---
description: Executa UMA sessão do gov-loop do Elev CRM (uma feature de governança, depois morre)
---
Execute o protocolo do gov-loop — Elev CRM (Governança de Atendimento): leia
