-- 0208 — a probabilidade que o VENDEDOR aposta
--
-- RENUMERADA de 0206 para 0208 em 2026-09-04: o upstream usou 0206 para
-- `contact_ai_authorization` e 0207 para `credenciais_de_ia_voltam_a_ser_lidas`.
-- Esta migration e nossa e nunca foi para la; quem chegou depois cede o numero., ao lado da que a IA calcula.
--
