...
- **Deps:** WAHA Core local (`elevcrm-waha`, :3030), Redis + serverless-redis-http
...
- **Worktree:** `~/ElevCRM-qa` (branch `qa/vps-experience`), `node_modules`
...
- **M3** — README self-host aponta repo/imagem `elevcrm/*`; kit usa `melgarafael/*`.
