...
- **W9 — Billing**: `/app/settings/billing` static placeholder card pointing to `suporte@elevcrm.app`.
...
Placeholder explícito pra não deixar item quebrado na sidebar de settings. Mostra mensagem "Em breve" + benefícios do plano + link `mailto:contato@elevcrm.com.br?subject=Billing` ou link pro WhatsApp da Elev CRM. Nenhuma lógica de billing real.
...
And botão "Falar com a Elev CRM" abre mailto
```
