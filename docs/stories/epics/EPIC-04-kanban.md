...
| Vocabulary inconsistente (string hardcoded em PT) | Baixa | Linter `eslint-plugin-elevcrm/no-hardcoded-pt-in-kanban` (regra P-07) — adicionar em S-04.06 se ausente |
