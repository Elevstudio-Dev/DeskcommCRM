...
- **Memórias persistentes do projeto** em `~/.claude/projects/-Users-rafaelmelgaco-ElevCRM/memory/`
  ...
  - `project_naming_and_timeline.md` — Elev CRM, MVP-B 8-12 semanas
...
- Supabase Studio: dashboard.supabase.com → projeto Elev CRM → Database → Tables (31 tabelas com RLS verde)
