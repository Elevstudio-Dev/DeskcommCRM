...
> Elev CRM via MCP: quais tools existem, o input/output exato de cada uma, a
...
O Elev CRM expõe um **servidor MCP org-scoped**. O agente externo se autentica
...
> Elev CRM**; o lado do Vendaval é o FG-01.
