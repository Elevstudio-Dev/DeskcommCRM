...
**Branch:** `feat/canais-oficial` · **Worktree:** `~/ElevCRM-canais`
...
continuam idênticos e verdes. Commitado com `ELEVCRM_GOV_INVARIANTS_EDIT=1` citado no
commit message.
