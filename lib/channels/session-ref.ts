...
export type ChannelSessionRef =
  ...
  // O IGSID da conta profissional. Coluna própria e não `meta_phone_number_id`
  // (migration 0211): a Graph API é a mesma, o identificador não — reusar a
  // coluna quebraria a `provider_ref_check`, que garante que a coluna do
  // provider da vez é NOT NULL.
...
export const CHANNEL_SESSION_REF_COLUMNS =
  "provider, waha_session_name, meta_phone_number_id, zernio_account_id, instagram_account_id";
