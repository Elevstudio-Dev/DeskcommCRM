...
export const DICIONARIO: Traducoes = {
  ...
  "Disponível assim que a Meta aprovar o aplicativo.": { es: "Disponible en cuanto Meta apruebe la aplicación." },
  Marcadores: { es: "Etiquetas" },
  "Marcadores salvos": { es: "Etiquetas guardadas" },
  "Esse marcador já existe.": { es: "Esa etiqueta ya existe." },
  "O limite é de 50 marcadores.": { es: "El límite es de 50 etiquetas." },
  "Marcadores da empresa": { es: "Etiquetas de la empresa" },
  "Servem para filtrar conversas e para medir. Quem atende aplica; só manager cria.": { es: "Sirven para filtrar conversaciones y para medir. Quien atiende las aplica; solo el manager las crea." },
  "ex.: urgente": { es: "ej.: urgente" },
  "Cor do marcador": { es: "Color de la etiqueta" },
  "Nenhum marcador ainda. Crie o primeiro acima.": { es: "Todavía no hay etiquetas. Crea la primera arriba." },
  conversas: { es: "conversaciones" },
  "Cor de": { es: "Color de" },
  "Em uso, mas fora da lista": { es: "En uso, pero fuera de la lista" },
  "Alguém digitou estes na conversa. Eles funcionam, mas não aparecem no filtro — e cada variação de um mesmo assunto divide a contagem.": { es: "Alguien las escribió en la conversación. Funcionan, pero no aparecen en el filtro — y cada variación de un mismo asunto divide el conteo." },
  "O vocabulário de marcadores da sua empresa — o que dá para filtrar e o que dá para medir.": { es: "El vocabulario de etiquetas de tu empresa — lo que se puede filtrar y lo que se puede medir." },
  Cinza: { es: "Gris" },
  Vermelho: { es: "Rojo" },
  Laranja: { es: "Naranja" },
  Amarelo: { es: "Amarillo" },
  ...
  "Instagram Direct — em breve": { es: "Instagram Direct — muy pronto" },
  "As mensagens de Direct, as respostas a stories e os pedidos de mensagem vão cair na mesma caixa de entrada das conversas de WhatsApp.": { es: "Los mensajes de Direct, las respuestas a historias y las solicitudes de mensaje van a llegar a la misma bandeja de entrada que las conversaciones de WhatsApp." },
  "O que já está pronto": { es: "Lo que ya está listo" },
  "O canal existe no sistema, ao lado do WhatsApp": { es: "El canal existe en el sistema, junto a WhatsApp" },
  "A caixa de entrada, os marcadores e a fila já funcionam para ele": { es: "La bandeja de entrada, las etiquetas y la cola ya funcionan para él" },
  "A IA segue as mesmas regras de silêncio que você já configurou": { es: "La IA sigue las mismas reglas de silencio que ya configuraste" },
  "O que falta, e não depende de nós": { es: "Lo que falta, y no depende de nosotros" },
  "A conta do Instagram precisa ser Profissional e estar ligada a uma Página do Facebook.": { es: "La cuenta de Instagram debe ser Profesional y estar vinculada a una Página de Facebook." },
  "A Meta precisa aprovar o aplicativo para ler e responder mensagens (App Review).": { es: "Meta debe aprobar la aplicación para leer y responder mensajes (App Review)." },
  "Dependendo do caso, a Meta pede também a verificação da empresa, com documento.": { es: "Según el caso, Meta pide también la verificación de la empresa, con documento." },
  "Esses três passos correm por fora e levam de dias a semanas. Assim que a aprovação sair, esta tela ganha o botão de conectar.": { es: "Esos tres pasos corren por fuera y llevan de días a semanas. En cuanto salga la aprobación, esta pantalla gana el botón de conectar." },
  "Conectar Instagram": { es: "Conectar Instagram" },
  "Disponível em breve": { es: "Disponible muy pronto" },
  "assumiu esta conversa": { es: "asumió esta conversación" },
  "Alguém do time assumiu esta conversa": { es: "Alguien del equipo asumió esta conversación" },
  "transferiu para": { es: "transfirió a" },
  "Transferida para": { es: "Transferida a" },
  "Conversa transferida": { es: "Conversación transferida" },
  "liberou esta conversa": { es: "liberó esta conversación" },
  "A conversa voltou para a fila": { es: "La conversación volvió a la cola" },
  "Distribuída para": { es: "Asignada a" },
  "O automático passou para": { es: "El automático pasó a" },
  "O automático passou para uma pessoa": { es: "El automático pasó a una persona" },
  Grupos: { es: "Grupos" },
  "Importar grupos do WhatsApp": { es: "Importar grupos de WhatsApp" },
  "grupos importados": { es: "grupos importados" },
  "Grupos importados com falhas": { es: "Grupos importados con fallos" },
  "não entraram": { es: "no entraron" },
  "Nenhum grupo encontrado neste número.": { es: "Ningún grupo encontrado en este número." },
  IA: { es: "IA" },
  ...
  // ─── Setores (migration 0213): tela, inbox, fio ───
  Setores: { es: "Sectores" },
  "Os grupos que atendem junto, quem está em cada um, e o menu que pergunta ao cliente com quem ele quer falar.": {
    es: "Los grupos que atienden juntos, quién está en cada uno, y el menú que pregunta al cliente con quién quiere hablar.",
  },
  "Os grupos que atendem junto — e o menu que pergunta ao cliente com quem ele quer falar.": {
    es: "Los grupos que atienden juntos — y el menú que pregunta al cliente con quién quiere hablar.",
  },
  "Os setores": { es: "Los sectores" },
  "Novo setor": { es: "Nuevo sector" },
  "Editar setor": { es: "Editar sector" },
  "Criar setor": { es: "Crear sector" },
  "Setor criado.": { es: "Sector creado." },
  "Setor atualizado.": { es: "Sector actualizado." },
  "Setor arquivado.": { es: "Sector archivado." },
  "Arquivar o setor": { es: "Archivar el sector" },
  "O nome é o que o cliente vê no menu de primeiro contato.": {
    es: "El nombre es lo que el cliente ve en el menú de primer contacto.",
  },
  "Cor do setor": { es: "Color del sector" },
  // O placeholder do nome do setor é um exemplo — e o exemplo se traduz.
  Financeiro: { es: "Finanzas" },
  "Nenhum setor ainda. Crie o primeiro — Assistência, Financeiro, Recepção — e diga quem atende em cada um.": {
    es: "Ningún sector todavía. Crea el primero — Asistencia, Finanzas, Recepción — y di quién atiende en cada uno.",
  },
  "Ninguém neste setor ainda": { es: "Nadie en este sector todavía" },
  "Membros de": { es: "Miembros de" },
  "Quem atende em": { es: "Quién atiende en" },
  "Quem está no setor vê a fila dele. Uma pessoa pode estar em mais de um setor; quem não está em nenhum vê tudo.": {
    es: "Quien está en el sector ve su cola. Una persona puede estar en más de un sector; quien no está en ninguno ve todo.",
  },
  "Ninguém na equipe ainda. Convide pessoas em Equipe.": { es: "Nadie en el equipo todavía. Invita personas en Equipo." },
  "Membros atualizados.": { es: "Miembros actualizados." },
  "Menu de primeiro contato": { es: "Menú de primer contacto" },
  "Quando alguém escreve pela primeira vez, o sistema responde com a lista de setores e direciona pela resposta. A equipe pode transferir depois, a qualquer momento.": {
    es: "Cuando alguien escribe por primera vez, el sistema responde con la lista de sectores y dirige según la respuesta. El equipo puede transferir después, en cualquier momento.",
  },
  "Perguntar o setor no primeiro contato": { es: "Preguntar el sector en el primer contacto" },
  "Precisa de pelo menos 2 setores": { es: "Necesita al menos 2 sectores" },
  Saudação: { es: "Saludo" },
  "Quando não entender (um lembrete, só)": { es: "Cuando no entienda (un recordatorio, solo)" },
  "{setor} vira o nome do setor escolhido.": { es: "{setor} se convierte en el nombre del sector elegido." },
  "Se o cliente não escolher, cai em": { es: "Si el cliente no elige, cae en" },
  "Nenhum setor (fica na fila geral)": { es: "Ningún sector (queda en la cola general)" },
  "Como o cliente vai receber": { es: "Cómo lo va a recibir el cliente" },
  "Crie pelo menos dois setores para ver a prévia.": { es: "Crea al menos dos sectores para ver la vista previa." },
  "Salvar menu": { es: "Guardar menú" },
  "Menu salvo.": { es: "Menú guardado." },
  "Filtrar por setor": { es: "Filtrar por sector" },
  "Todos os setores": { es: "Todos los sectores" },
  "Sem setor": { es: "Sin sector" },
  "Transferir para setor…": { es: "Transferir a un sector…" },
  "Transferir para um setor": { es: "Transferir a un sector" },
  "A conversa vai para a fila do setor escolhido. Quem é o responsável hoje deixa de ser, e a mudança fica registrada no histórico.": {
    es: "La conversación va a la cola del sector elegido. Quien es el responsable hoy deja de serlo, y el cambio queda registrado en el historial.",
  },
  Setor: { es: "Sector" },
  "Escolha o setor": { es: "Elige el sector" },
  "Nenhum setor (tirar do setor)": { es: "Ningún sector (sacar del sector)" },
  "Nenhum setor cadastrado. Crie em Configurações → Setores.": { es: "Ningún sector registrado. Crea uno en Configuración → Sectores." },
  "Conversa transferida para o setor.": { es: "Conversación transferida al sector." },
  "Conversa tirada do setor.": { es: "Conversación sacada del sector." },
  "O cliente escolheu o setor": { es: "El cliente eligió el sector" },
  "tirou a conversa do setor": { es: "sacó la conversación del sector" },
  "A conversa saiu do setor": { es: "La conversación salió del sector" },
