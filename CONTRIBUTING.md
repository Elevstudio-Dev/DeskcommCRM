...
6. CI deve passar antes de merge. Obrigatórios: `verify`, `invariants` (isolamento RLS),
   ...
   > `gh api repos/Elevstudio-Dev/ElevCRM/branches/main/protection --jq '.required_status_checks.contexts'`
...
**[GitHub Discussions](https://github.com/Elevstudio-Dev/ElevCRM/discussions)** — é o canal público,
