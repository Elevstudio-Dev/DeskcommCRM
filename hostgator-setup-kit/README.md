# ElevCRM — Kit de Instalação (HostGator)

Este kit sobe o **ElevCRM** no seu servidor VPS da HostGator. Você tem dois caminhos:
...
3. Diga: *"instala o ElevCRM pra mim"*. Ele lê o `CLAUDE.md` e conduz tudo —
