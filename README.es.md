...
# 🛠️ Elev CRM — el Sistema Operativo de Ventas con IA, open source, para WhatsApp
...
>
> Elev CRM se desarrolla en **alianza con HostGator**: el [`hostgator-setup-kit/`](hostgator-setup-kit/)
...
y dile *"instálame el Elev CRM"*. Lee el [`CLAUDE.md`](hostgator-setup-kit/CLAUDE.md) del kit
...
**Elev CRM** viene de **Desk** (escritorio) + **comm** (comercio): toda la operación de ventas de tu negocio en un solo escritorio, operada por personas y agentes de IA trabajando juntos.
...
Para **vulnerabilidades de seguridad**, **NO abras un issue público** — usa el [reporte privado de vulnerabilidades](https://github.com/Elevstudio-Dev/ElevCRM/security/advisories/new). Detalles en [`SECURITY.md`](SECURITY.md).
...
- **MCP público** — capacidades del CRM expuestas al ecosistema de agentes: enchufa el agente que quieras y opera el Elev CRM.
...
- **Discusiones:** [GitHub Discussions](https://github.com/Elevstudio-Dev/ElevCRM/discussions)
