...
# Elev CRM — imagem de produção self-host (Next.js standalone).
# Build: docker build --build-arg NEXT_PUBLIC_SUPABASE_URL=... -t elevcrm-app .
...
LABEL org.opencontainers.image.source="https://github.com/melgarafael/DeskcommCRM" \
      ...
      org.opencontainers.image.title="Elev CRM"
