...
# 🛠️ Elev CRM — The open-source AI Sales OS for WhatsApp
...
>
> Elev CRM is developed in **partnership with HostGator**: the [`hostgator-setup-kit/`](hostgator-setup-kit/)
...
*"install Elev CRM for me"*. It reads the kit's [`CLAUDE.md`](hostgator-setup-kit/CLAUDE.md)
...
**Elev CRM** comes from **Desk** + **comm** (commerce): your entire sales operation on a single desk, run by people and AI agents working together.
...
For **security vulnerabilities**, **do NOT open a public issue** — use [private vulnerability reporting](https://github.com/Elevstudio-Dev/ElevCRM/security/advisories/new). Details in [`SECURITY.md`](SECURITY.md).
...
- **Public MCP** — CRM capabilities exposed to the agent ecosystem: plug in any agent and it operates Elev CRM.
...
- **Discussions:** [GitHub Discussions](https://github.com/Elevstudio-Dev/ElevCRM/discussions)
...
- The community that took Elev CRM from e-commerce to clinics, real estate, info-products and beyond — you defined what this project is.
